            ...
            <div className="max-w-screen-2xl mx-auto flex justify-between py-2">
                ...
                <span className="flex space-x-2">
                    <p className="bg-slate-100 rounded-sm flex items-center">
                        <Image height={48} width={48} src="/card-providers/mastercard_logo.svg" alt="MasterCard"/>
                    </p>
                    <p className="bg-slate-100 rounded-sm flex items-center">
                        <Image height={48} width={48} src="/card-providers/visa_logo.svg" alt="MasterCard"/>
                    </p>
                    <p className="bg-slate-100 rounded-sm flex items-center">
                        <Image height={48} width={48} src="/card-providers/paypal_logo.svg" alt="MasterCard"/>
                    </p>
                </span>
            </div>
        </div>
